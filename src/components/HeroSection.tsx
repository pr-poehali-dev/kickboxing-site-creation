      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 font-montserrat animate-fade-in">
            СЕКЦИЯ
            <span className="block text-6xl md:text-8xl text-orange-400">КИКБОКСИНГА</span>
          </h1>
          
          <p className="text-xl md:text-2xl mb-8 text-red-100 max-w-2xl mx-auto leading-relaxed">
            Профессиональные тренировки для всех уровней подготовки. 
            Развивай силу, выносливость и боевой дух!
          </p>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              ...
              <div className="text-sm uppercase tracking-wide">мастера спорта</div>
            </div>
          </div>
        </div>
      </div>
